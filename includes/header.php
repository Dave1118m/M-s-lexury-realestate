        ...
        <div class="container">
            ...
            <nav class="main-nav">
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="<?php echo SITE_URL; ?>/pages/search.php">Properties ▾</a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php" style="font-weight: bold; color: var(--color-gold);">All Properties</a></li>
                            <li><hr style="border-color: var(--color-gray-200); margin: 0.5rem 0;"></li>
                            <?php foreach ($categories as $cat): 
                                $cat_name = trim($cat['name']);
                                if ($cat_name === '' || $cat_name === '.') continue;
                            ?>
                                <li><a href="<?php echo SITE_URL; ?>/pages/search.php?category=<?php echo $cat['slug']; ?>"><?php echo $cat['name']; ?></a></li>
                            <?php endforeach; ?>
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?q=Addis Ababa">Addis Ababa</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?q=Hawassa">The Hawassa</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?q=Bishoftu">Bishoftu</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?q=Bahir Dar">Bahir Dar</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#">Services ▾</a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?type=sale">Buy</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/search.php?type=rent">Rent</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/about.php">Sell with Us</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/announcements.php" style="color: var(--color-gold);">Special Offers</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/agents.php">Our Agents</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="<?php echo SITE_URL; ?>/pages/blog.php">Insights ▾</a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo SITE_URL; ?>/pages/blog.php?category=Market%20Report">Market Reports</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/blog.php?category=Neighborhood%20Guide">Neighborhood Guides</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/blog.php?category=Architecture%20%26%20Design">Design & Architecture</a></li>
                            <li><a href="<?php echo SITE_URL; ?>/pages/blog.php?category=Company%20News">Company News</a></li>
                        </ul>
                    </li>
                </ul>
            </nav>
